                ...
                @foreach ($categories as $category)
                    <div class="col-md-6 col-lg-3">
                        <div class="card h-100 border-black bg-dark text-center">
                            <img src="{{ Storage::url($category->image_url) }}" class="card-img-top" alt="Protein"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <h3 class="h4 text-success">{{$category->name}}</h3>
                            ...
                            <div class="card-footer bg-success border-0 py-3">
                                @auth
                                    <a href="{{ route('food-item.index', ['category' => $category->id]) }}"
