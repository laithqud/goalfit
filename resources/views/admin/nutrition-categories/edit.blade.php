...
@section('title', 'Edit Nutrition Category')
            ...
            <div class="col-12">
                <div class="bg-black bg-opacity-75 rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('admin.nutrition-categories.index') }}" class="btn btn-sm btn-secondary">
                            <i class="fas fa-arrow-left me-1"></i> Back to List
                        </a>
                    </div>

                    <form method="POST" action="{{ route('admin.nutrition-categories.update', $category->id) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($category->image_url)
                                        <small class="text-muted">Current:
                                            <a href="{{ asset('storage/' . $category->image_url) }}" target="_blank">View
                                                Image</a>
                                        </small>
                                    @endif
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control bg-secondary border-dark text-white"
                                        id="calories" name="calories" value="{{ old('calories', $category->calories) }}"
                                        required>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" step="0.1"
                                            ...
                                            name="protien" value="{{ old('protien', $category->protien) }}" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" step="0.1"
                                            ...
                                            value="{{ old('carbs', $category->carbs) }}" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" step="0.1"
                                            ...
                                            value="{{ old('fat', $category->fat) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control bg-secondary border-dark text-white" id="nutrients"
                                        name="nutrients"
                                        rows="3">{{ old('nutrients', json_encode($category->nutrients)) }}</textarea>
