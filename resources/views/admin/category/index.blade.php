            ...
            <div class="col-12">
                <div class="bg-black bg-opacity-75 rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="
                            {{-- {{ route('admin.food-categories.create') }} --}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="bg-secondary rounded-circle d-flex align-items-center justify-content-center"
                                            ...
                                            @break
                                            @case('Vegetables')
                                            <i class="fas fa-carrot text-light"></i>
                                            @break
                                            @case('Meat')
                                            <i class="fas fa-drumstick-bite text-light"></i>
                                            @break
                                            @case('Dairy')
                                            <i class="fas fa-cheese text-light"></i>
                                            @break
                                            @case('Grains')
                                            <i class="fas fa-bread-slice text-light"></i>
                                            @break
                                            @default
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="
                                                {{-- {{ route('admin.food-categories.edit', $category->id) }} --}}
                                                 " class="btn btn-sm btn-warning" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="
                                                {{-- {{ route('admin.food-categories.destroy', $category->id) }} --}}
                                                 " method="POST">
                                                @csrf
                                                @method('DELETE')
