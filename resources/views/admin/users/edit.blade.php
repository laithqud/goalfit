    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-black bg-opacity-75 rounded p-4">
                <h6 class="mb-4 text-light">Edit User: {{ $user->name }}</h6>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select bg-dark text-light" id="home_gym_id" name="home_gym_id">
                                ...
                                @foreach($gyms as $gym)
                                    <option value="{{ $gym->id }}" {{ old('home_gym_id', $user->home_gym_id) == $gym->id ? 'selected' : '' }}>
                                        {{ $gym->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @if($user->profile_photo_path)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $user->profile_photo_path) }}" width="100" class="img-thumbnail">
                                </div>
                            @endif
                        </div>
                        <div class="col-md-6">
