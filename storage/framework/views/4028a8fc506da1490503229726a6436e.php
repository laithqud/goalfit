    ...
    <nav class="d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse bg-dark position-absolute top-100 start-0 w-100 p-3" id="mobileMenu"
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <a href="<?php echo e(route('gym.index')); ?>" class="text-decoration-none text-white">Gyms</a>
                <a href="<?php echo e(route('workout.index')); ?>" class="text-decoration-none text-white">Workout</a>
                <a href="<?php echo e(route('nutrition.index')); ?>" class="text-decoration-none text-white">Nutrition</a>
