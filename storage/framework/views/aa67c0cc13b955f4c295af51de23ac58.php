...
<?php $__env->startSection('title', 'GoalFit - About Us'); ?>

<?php $__env->startSection('content'); ?>

    <div class="hero-section position-relative"
        style="background-image: url('<?php echo e(asset('images/about-hero.jpg')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; width: 100%; height: 70vh;">
    ...
    <section id="our-story" class="py-5 bg-dark">
        <div class="container">
            ...
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('images/about-story1.jpg')); ?>" class="img-fluid rounded shadow-lg"
            ...
            <div class="row g-5 mb-5 flex-lg-row-reverse">
                ...
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('images/about-story2.jpg')); ?>" class="img-fluid rounded shadow-lg"
                        alt="Team working">
                </div>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('images/about-story3.jpg')); ?>" class="img-fluid rounded shadow-lg" alt="Happy users">
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.public.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leoqu\Desktop\goalfit\resources\views/public/about-us.blade.php ENDPATH**/ ?>