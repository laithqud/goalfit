    ...
    <div class="container">
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3 col-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="/shop" class="text-white-50 hover-white text-decoration-none">Our
                            Products</a></li>
                    <li class="mb-2"><a href="/contact" class="text-white-50 hover-white text-decoration-none">Contact
                            Us</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 col-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="/contact" class="text-white-50 hover-white text-decoration-none">FAQs</a>
                    </li>
            ...
            <div class="col-md-3 col-6 d-flex align-items-center justify-content-center">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="GoalFit Logo" class="img-fluid" style="max-height: 120px;">
            </div>
        </div>
        ...
        <div class="text-center mb-4">
            ...
            <a href="https://www.goalfit.com/"
                class="website-footer text-decoration-none text-light fw-bold">www.goalfit.com</a>
        </div>
...
</footer><?php /**PATH C:\Users\leoqu\Desktop\goalfit\resources\views/layouts/public/__footer.blade.php ENDPATH**/ ?>