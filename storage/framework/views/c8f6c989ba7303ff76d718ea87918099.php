                ...
                <div class="card border-0 shadow-lg" style="background-color: #1e1e1e;">
                    ...
                    <div class="card-header bg-transparent border-bottom border-secondary">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-sm px-3"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center mb-4 mb-md-0">
                                <div class="position-relative mx-auto" style="width: 180px;">
                                    <img src="<?php echo e(Auth::user()->profile_photo_path ? asset('storage/' . Auth::user()->profile_photo_path) : asset('images/default-profile.jpg')); ?>"
                            ...
                            <div class="col-md-8">
                                <div class="d-flex flex-column h-100">
                                    <!-- Basic Info -->
                                    <div class="mb-4">
                                        <h3 class="text-white"><?php echo e(Auth::user()->name); ?></h3>
                                        <p class="text-muted mb-2">
                                            <i class="fas fa-envelope me-2"></i> <?php echo e(Auth::user()->email); ?>
                                        ...
                                        <?php if(Auth::user()->phone): ?>
                                            <p class="text-muted mb-2">
                                                <i class="fas fa-phone me-2"></i> <?php echo e(Auth::user()->phone); ?>
                                    ...
                                    <div class="d-flex gap-2 flex-wrap mb-4">
                                        <?php if(Auth::user()->birth_date): ?>
                                            <span class="badge bg-dark text-white px-3 py-2">
                                                ...
                                                <?php echo e(\Carbon\Carbon::parse(Auth::user()->birth_date)->age); ?> years
                                            </span>
                                        <?php endif; ?>

                                        <?php if(Auth::user()->gender): ?>
                                            <span class="badge bg-dark text-white px-3 py-2">
                                                <i class="fas fa-<?php echo e(Auth::user()->gender == 'male' ? 'mars' : 'venus'); ?> me-2"
                                                    style="color: <?php echo e(Auth::user()->gender == 'male' ? '#1E90FF' : '#FF69B4'); ?>;"></i>
                                                <?php echo e(ucfirst(Auth::user()->gender)); ?>

                                            </span>
                                        <?php endif; ?>

                                        <?php if(Auth::user()->height_cm): ?>
                                            <span class="badge bg-dark text-white px-3 py-2">
                                                <i class="fas fa-ruler-vertical me-2" style="color: #7CFC00;"></i>
                                                <?php echo e(Auth::user()->height_cm); ?> cm
                                            </span>
                                        <?php endif; ?>

                                        <?php if(Auth::user()->weight_kg): ?>
                                            <span class="badge bg-dark text-white px-3 py-2">
                                                <i class="fas fa-weight me-2" style="color: #FF6347;"></i>
                                                <?php echo e(Auth::user()->weight_kg); ?> kg
                                            </span>
                                        <?php endif; ?>

                                        <?php if(Auth::user()->height_cm && Auth::user()->weight_kg): ?>
                                            <?php
                                                $bmi = Auth::user()->weight_kg / ((Auth::user()->height_cm / 100) ** 2);
                                            ?>
                                            <span class="badge bg-dark text-white px-3 py-2">
                                                <i class="fas fa-heartbeat me-2" style="color: 
                                                                                                <?php if($bmi < 18.5): ?> #ADD8E6
                                                                                                <?php elseif($bmi >= 18.5 && $bmi < 25): ?> #90EE90
                                                                                                <?php elseif($bmi >= 25 && $bmi < 30): ?> #FFA500
                                                                                                <?php else: ?> #FF4500
                                                                                                <?php endif; ?>
                                                                                            ;"></i>
                                                BMI: <?php echo e(number_format($bmi, 1)); ?>
                                    ...
                                    <div class="mt-auto">
                                        <?php if(Auth::user()->homeGym): ?>
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted mb-0"><?php echo e(Auth::user()->homeGym->name); ?></p>
                                                    <small class="text-muted"><?php echo e(Auth::user()->homeGym->location); ?></small>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted mb-0"><?php echo e(Auth::user()->created_at->format('F j, Y')); ?>

                                                </p>
                                                <small
                                                    class="text-muted"><?php echo e(Auth::user()->created_at->diffForHumans()); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
