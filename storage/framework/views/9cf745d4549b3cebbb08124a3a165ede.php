...
<?php $__env->startSection('title', 'GoalFit - Home'); ?>

<?php $__env->startSection('content'); ?>

    <div class="hero-section position-relative"
        style="background-image: url('<?php echo e(asset('images/hero.jpg')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; width: 100%; height: 100vh;">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center pb-5">
            ...
            <div id="FeaturesDiv" class="p-5 d-flex gap-5 border rounded border-light">
                ...
                <a href="#gym" class="text-decoration-none">
                    <div class="d-flex flex-column align-items-center">
                        <div class="rounded-circle divSizeFeature"
                            style="background-image: url(<?php echo e(asset('images/feature1.png')); ?>); background-size: cover; background-position: center;">
                        </div>
                ...
                <a href="#home" class="text-decoration-none">
                    <div class="d-flex flex-column align-items-center">
                        <div class="rounded-circle divSizeFeature"
                            style="background-image: url(<?php echo e(asset('images/feature2.jpg')); ?>); background-size: cover; background-position: center;">
                        </div>
                ...
                <a href="#nutrition" class="text-decoration-none">
                    <div class="d-flex flex-column align-items-center">
                        <div class="rounded-circle divSizeFeature"
                            style="background-image: url(<?php echo e(asset('images/feature3.jpg')); ?>); background-size: cover; background-position: center;">
                        </div>
                        <div class="border border-light border-start bg-dark" style="height: 40px;"></div>
        ...
        <div id="conainGymSection" class="d-flex mt-5 align-items-center" style="height: 100vh;">
                ...
                <div id="carouselExampleControls" class="carousel slide h-100" data-bs-ride="carousel">
                    <div class="carousel-inner h-100">
                        <div class="carousel-item active h-100">
                            <img src="<?php echo e(asset('images/landingGym1.jpg')); ?>" class="d-block w-100 h-100"
                                style="object-fit: cover;" alt="...">
                        </div>
                        <div class="carousel-item h-100">
                            <img src="<?php echo e(asset('images/landingGym2.jpg')); ?>" class="d-block w-100 h-100"
                                style="object-fit: cover;" alt="...">
                        </div>
                        <div class="carousel-item h-100">
                            <img src="<?php echo e(asset('images/landingGym3.jpg')); ?>" class="d-block w-100 h-100"
                                style="object-fit: cover;" alt="...">
                        </div>
                    </div>
            ...
            <div id="gymTextDiv" class="w-50 h-100 position-relative">
                <div class="position-absolute w-100 h-100" style="
                                                                        background: url('<?php echo e(asset('images/dumbble2.jpg')); ?>') center/cover;
                                                                        filter: blur(6px);
                                                                        opacity: 1;
                                                                        z-index: 1;
                                                                     ">
    ...
    <section id="home" class="p-3 p-md-5" style="background-color: #373740; height: 100vh;">
        ...
        <div class="d-flex flex-column-reverse flex-md-row align-items-center border border-black p-3 rounded-3"
            ...
            <div class="w-100 w-md-50 h-100 mb-4 mb-md-0">
                <img src="<?php echo e(asset('images/home-workout.jpg')); ?>" alt="Person exercising at home"
    ...
    <section id="nutrition" class="position-relative"> <!-- Added position relative for potential overlays -->
        <div class="w-100 h-100 min-vh-100 bg-dark"> <!-- Added bg-dark as fallback -->
            <img src="<?php echo e(asset('images/healthyFood.jpeg')); ?>" alt="Healthy food selection"
...
<?php echo $__env->make('layouts.public.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leoqu\Desktop\goalfit\resources\views/home.blade.php ENDPATH**/ ?>