...
<?php $__env->startSection('title', 'Create Nutrition Category'); ?>
            ...
            <div class="col-12">
                <div class="bg-black bg-opacity-75 rounded p-4">
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        <a href="<?php echo e(route('admin.nutrition-categories.index')); ?>" class="btn btn-secondary btn-sm">
                            <i class="fas fa-arrow-left me-1"></i> Back
                        </a>
                    </div>

                    <form method="POST" action="<?php echo e(route('admin.nutrition-categories.store')); ?>"
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leoqu\Desktop\goalfit\resources\views/admin/nutrition-categories/create.blade.php ENDPATH**/ ?>